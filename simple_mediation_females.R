...
df_female_domsp_weekday %>%
  select(hicid, model4_trajectory_assignments, Age, Remoteness, Indigenous, SEP) -> relevant_female_data
...
inner_join(relevant_female_data, wave_6_relevant_data, by = "hicid") -> domsp_wave6
inner_join(domsp_wave6, wave_8_relevant_data, by = "hicid") -> df_females
