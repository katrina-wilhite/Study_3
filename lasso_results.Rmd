...
```{r echo=FALSE}
model_selection_table %>% 
  kbl(caption = "Supplementary Table 1. Lasso Model Selection") %>% 
  kable_classic(html_font = "Arial") %>% 
  pack_rows("Males (Single Movement Behaviours)", 1,6) %>% 
  pack_rows("Males (Combinations of Movement Behaviours)", 7, 12) %>% 
  pack_rows("Females (Single Movement Behaviours)", 13, 18) %>% 
  pack_rows("Females (Combinations of Movement Behaviours)", 19, 24) %>% 
