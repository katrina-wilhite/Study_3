...
results_table %>% 
  ...
  column_spec(3, bold = ifelse(results_table$p == "0.04" | results_table$p == "<.01" | results_table$p == "0.02", TRUE, FALSE)) %>% 
  column_spec(7, bold = ifelse(results_table$p == "0.04" |results_table$p == "0.03" | results_table$p == "0.02" | results_table$p == "<.01", TRUE, FALSE)) %>% 
