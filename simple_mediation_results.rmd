...
results_table$`Estimate (SE)`[results_table$`Estimate (SE)` == "-0.1 (0.04)"] <- "-0.10 (0.04)"
...
```{r echo=FALSE}
results_table %>% 
  kbl(caption = "Table 4.3 Mediation Effects of Movement Behaviour Trajectories and Socio-Emotional Outcomes") %>% 
