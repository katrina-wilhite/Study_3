...
male_data <- function(){
  cloud_get(path = "Shared/LSAC - Katrina/Study_2/Study_2/df_males_domsp_weekday.RData", envir = globalenv())
  .GlobalEnv$lsac_wave6 <- cloud_get("Shared/LSAC - Katrina/General Release/Survey data/SAS/lsacgrb10.sas7bdat")
  .GlobalEnv$lsac_wave8 <- cloud_get("Shared/LSAC - Katrina/General Release/Survey data/SAS/lsacgrb14.sas7bdat")
}


female_data <- function(){
  cloud_get(path = "Shared/LSAC - Katrina/Study_2/Study_2/df_females_domsp_weekday.RData", envir = globalenv())
  .GlobalEnv$lsac_wave6 <- cloud_get("Shared/LSAC - Katrina/General Release/Survey data/SAS/lsacgrb10.sas7bdat")
  .GlobalEnv$lsac_wave8 <- cloud_get("Shared/LSAC - Katrina/General Release/Survey data/SAS/lsacgrb14.sas7bdat")
}
